...
while true; do
  ...
  echo -e "${RED}'ggg      ,gg'''  .    ggg       Auto Installer Magelzylxdev   ${NC}"
  echo -e "${RED}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : magelzylxdev      ${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Creadit  : Magelzylxdev  ${NC}"
  echo -e "${RED} ggg.    '.'''ggggggp           • Support by Magelzylxdev ${NC}"
